package org.book.manager.security;
...
class OAuthClientHttpRequestInterceptorTest {
    ...
    void intercept_AuthorizationHeaderIsNotSet_AddsAuthorizationHeader() throws IOException {
        ...
        var authentication = new TestingAuthenticationToken("jon.dick", "password");
        SecurityContextHolder.getContext().setAuthentication(authentication);

        var authorizedClient = new OAuth2AuthorizedClient(mock(), "joe.daun",
